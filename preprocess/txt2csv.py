...
#2019-01-29
#by SUN chen
#This file will automatically convert txt file to csv file .
#Input: transcript file as txt format.Output:two csv file ,one is the true sentence and one is actual sentence.
